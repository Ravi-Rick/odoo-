...
class ProductsAndCategories(http.Controller):
        ...
        if user_id and login_token:
            ...
            for product in products:
                ...
                if cart and cart.order_line:
                    ...
                    if order_line_item:
                        cart_info["in_cart"] = True
                        cart_info["uom_category_id"] = order_line_item.product_uom_category_id.id
                        cart_info["uom_id"] = order_line_item.product_uom.id
                        cart_info["uom"] = order_line_item.product_uom.name
                        cart_info["uom_description"] = order_line_item.pricelist_item_id.uom_description if order_line_item.pricelist_item_id.uom_description else ""
                        cart_info["uom_type"] = order_line_item.product_uom.uom_type
                        cart_info["sales_price"] = order_line_item.pricelist_item_id.fixed_price
                        cart_info["discount_price"] = order_line_item.pricelist_item_id.discount_price
                        cart_info["discount_percent"] = order_line_item.pricelist_item_id.discount_percent
                        cart_info["unit_price"] = order_line_item.pricelist_item_id.unit_price
                        cart_info["currency"] = order_line_item.pricelist_item_id.currency_id.name
                ...
                if price_list:
                    for info in price_list:
                        uom_list.append({
                            "product_uom_category_id": info.uom_id.category_id.id,
                    ...
                    uom_list.append({
                        "product_uom_category_id": product.uom_category_id.id,
    ...
    def get_product_details(self, user_id=False, login_token=False, product_slug=False):
        ...
        if price_list:
            for info in price_list:
                uom_list.append({
                    "uom_category_id": info.uom_id.category_id.id,
                    "uom_id": info.uom_id.id,
                    "uom": info.uom_id.name,
                    "uom_description": info.uom_description if info.uom_description else "",
                    "uom_type": info.uom_id.uom_type,
